                ...
                <div class="row">
                    <div class="col-12 col-lg-7">
                        ...
                        <div class="row konsultasi__page-item small">
                            ...
                            <div class="col-2 col-md-2 tx text-end">Senin & Kamis</div>
                            <div class="col-2 col-md-2 tx text-end">17:00-18:00</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            <div class="col-6 col-md-6 tx">dr. Dedyanto Jenky Saputra, M.Gizi</div>
                            <div class="col-2 col-md-2 tx text-center">Gizi</div>
                            <div class="col-2 col-md-2 tx text-end">Senin-Minggu</div>
                            <div class="col-2 col-md-2 tx text-end">19:00-21:00</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            ...
                            <div class="col-2 col-md-2 tx text-end">Senin-Jumat</div>
                            <div class="col-2 col-md-2 tx text-end">17:00-19:00</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            ...
                            <div class="col-2 col-md-2 tx text-end">Senin</div>
                            <div class="col-2 col-md-2 tx text-end">11:00-12:00</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            <div class="col-6 col-md-6 tx">dr. Hastarita Lawrenti</div>
                            <div class="col-2 col-md-2 tx text-center">Onkologi</div>
                            <div class="col-2 col-md-2 tx text-end">Selasa, Rabu, & Kamis</div>
                            <div class="col-2 col-md-2 tx text-end">18:30-20:30</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            <div class="col-6 col-md-6 tx">dr. Lucky Taufika Yuhedi, Sp. Onk.Rad</div>
                            <div class="col-2 col-md-2 tx text-center">Radiasi Onkologi</div>
                            <div class="col-2 col-md-2 tx text-end">Selasa</div>
                            <div class="col-2 col-md-2 tx text-end">19:30-21:00</div>
                        </div>
                        <div class="row konsultasi__page-item">
                            <div class="col-6 col-md-6 tx">dr. Reza Musmarliansyah, Sp. B (K) Onk</div>
                            <div class="col-2 col-md-2 tx text-center">Bedah Onkologi</div>
                            <div class="col-2 col-md-2 tx text-end">Selasa & Kamis</div>
                            <div class="col-2 col-md-2 tx text-end">13:00-14:00</div>
                        </div>
                    </div>
                    
                    <div class="col-12 col-lg-5 rg">
